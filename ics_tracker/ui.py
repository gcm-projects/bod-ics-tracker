...
from .config import LOGO_FULL_DARK
...
def run():
    ...
    # Branding above the page navigation. The app is pinned to dark
    # (config.toml), so the white "GCM" logo is always the right one.
    st.logo(LOGO_FULL_DARK, size="large")
